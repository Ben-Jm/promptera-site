...
(function(){
  ...
  var DATA = {
    cs1:{eyebrow:'Case study · Financial services',title:'Loan Application System',cta:'Fix a journey like this, start free',ctx:'Re: journey like the loan application case',
      body:'<h4>The situation</h4><p>A lending institution was watching a third of applications die halfway through. The brief was "make the form look better." The problem was never how it looked.</p>'+
      '<h4>What we did</h4><p>We sat with real applicants and watched them fill it in. The form asked too much, in the wrong order, and punished mistakes after submission instead of preventing them. We redesigned the journey. Fewer fields. Errors caught at the start instead of after. Steps ordered the way people actually think, not the way the database wanted them.</p>'+
    ...
    cs2:{eyebrow:'Case study · Multi-sector digital',title:'Customer-Facing Platform',cta:'Fix a journey like this, start free',ctx:'Re: journey like the customer platform case',
      body:'<h4>The situation</h4><p>A customer platform was live, money had been spent on it, and people quietly avoided it. Customers defaulted to phoning instead. Every call was a sign the digital journey had failed them somewhere.</p>'+
      '<h4>What we did</h4><p>We mapped where people fell out of the digital journey and why they reached for the phone instead. Then we redesigned around what customers actually needed to find and do. That meant removing steps, not adding features.</p>'+
    ...
    cs3:{eyebrow:'Case study · Regulatory & enterprise',title:'Compliance Management Tools',cta:'Fix a journey like this, start free',ctx:'Re: journey like the compliance tools case',
      body:'<h4>The situation</h4><p>Compliance work lived in scattered documents and personal spreadsheets. Every audit meant weeks of reconstruction, and gaps turned up late, right when they were most expensive to fix.</p>'+
      '<h4>What we did</h4><p>We shadowed the people doing the work, mapped the real process instead of the documented one, and redesigned the tools around it. Compliance evidence got captured as the work happened, not reconstructed weeks later.</p>'+
    ...
    cs4:{eyebrow:'Case study · HR & internal adoption',title:'Interactive Culture Playbook',cta:'Fix a journey like this, start free',ctx:'Re: journey like the culture playbook case',
      body:'<h4>The situation</h4><p>The culture and onboarding material existed. Nobody opened the documents, though. New hires learned by asking around instead, picked up inconsistent answers, and took months to feel productive.</p>'+
      '<h4>What we did</h4><p>We redesigned the material as an interactive playbook, built around what new employees actually need in their first weeks and in the order they need it. Then we measured whether people actually used it.</p>'+
