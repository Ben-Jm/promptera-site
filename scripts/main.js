...
(function(){
  ...
  var cookiePrefsLink = document.getElementById('cookiePrefsLink');

  function showCookieBanner(){ cookieBanner.classList.add('show'); }
  ...
  cookiePrefsLink.addEventListener('click', function(){
